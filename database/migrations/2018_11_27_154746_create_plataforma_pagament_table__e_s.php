...
class CreatePlataformaPagamentTableEN extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('plataforma_pagamentEN', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('plataforma_pagamentEN', function($table) {
