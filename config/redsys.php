...
return [
    ...
    'url_notification'      => env('REDSYS_URL_NOTIFICATION','http://localhost:8000/apadrina/compra/plataform/redsys/notification'),
    ...
    'tradename'             => env('REDSYS_TRADENAME','Natura Catalunya'),
    'titular'               => env('REDSYS_TITULAR','Stania Kuspertova'),
