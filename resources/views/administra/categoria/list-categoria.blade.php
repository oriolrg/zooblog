                        ...
                        <tr class="success
                            ...
                            <td class="accions">
                              {{ csrf_field() }}
                                ...
                                <lavel id="modificar">
                                    <button type="submit" class="btn btn-primary btn-xs" name="id_restaurant" value="{{ $categoria->id }}" data-content="Modificar categoria" title="Modificar" data-toggle="popover" data-trigger="hover" onclick="window.location.href='{{asset('/administra/categoria/')}}/{{ $categoria->id }}/edit'">
