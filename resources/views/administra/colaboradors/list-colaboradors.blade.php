                        ...
                        <tr class="success
                            ...
                            <td class="accions">
                              {{ csrf_field() }}
                                ...
                                <lavel id="modificar">
                                    <button type="submit" class="btn btn-primary btn-xs" name="id_restaurant" value="{{ $familia->id }}" data-content="Modificar familia" title="Modificar" data-toggle="popover" data-trigger="hover" onclick="window.location.href='{{asset('/administra/colaboradors/')}}/{{ $familia->id }}/edit'">
                                        <i class="glyphicon glyphicon-pencil"> Modificar </i>
                                    </button>
                                </lavel>
                                <lavel id="eliminar">
                                    <button type="submit" class="buton eliminar btn btn-danger btn-xs" name="colaboradors" value="{{ $familia->id }}" data-content="Eliminar familia" title="Eliminar" data-toggle="popover" data-trigger="hover">
                                    {{ csrf_field() }}
