    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
              <div class="panel-heading">Col·laboradors</div>

                <div class="panel-body">
                <div>
                  <ul class="nav nav-tabs">
                    <li class="llistarCategoria" id="llistarCategoria"><a href="#">Llistar col·laboradors</a></li>
                    <li id="crearCategoria"><a href="#">Crear nou col·laborador</a></li>
                  </ul>
                </div>
                        ...
                        <tr class="success
                            ...
                            <td class="accions">
                              {{ csrf_field() }}
                                ...
                                <lavel id="modificar">
                                    <button type="submit" class="btn btn-primary btn-xs" name="id_restaurant" value="{{ $categoria->id }}" data-content="Modificar categoria" title="Modificar" data-toggle="popover" data-trigger="hover" onclick="window.location.href='{{asset('/administra/colaboradors/')}}/{{ $categoria->id }}/edit'">
                                        <i class="glyphicon glyphicon-pencil"> Modificar </i>
                                    </button>
                                </lavel>
                                <lavel id="eliminar">
                                    <button type="submit" class="buton eliminar btn btn-danger btn-xs" name="colaboradors" value="{{ $categoria->id }}" data-content="Eliminar categoria" title="Eliminar" data-toggle="popover" data-trigger="hover">
                                    {{ csrf_field() }}
                ...
                <div id="formCategoria">
                    <form  enctype="multipart/form-data" action="{{ url('administra/colaboradors') }}" method="POST">
                    {{ csrf_field() }}
                            @if(isset($post))
