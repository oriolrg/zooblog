                        ...
                        <tr class="success
                            ...
                            <td class="accions">
                              {{ csrf_field() }}
                                ...
                                <lavel id="eliminar">
                                    <button class="buton eliminar btn btn-danger btn-xs" name="animal" value="{{ $animal->id }}" data-content="Eliminar animal" title="Eliminar" data-toggle="popover" data-trigger="hover">
                                    {{ csrf_field() }}
