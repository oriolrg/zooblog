      ...
      <div class="card mbr-col-sm-3 mbr-col-md-12 mbr-col-lg-3">
        <a  class="portfolio-link" href="{{asset('familia')}}/especie/{{$especie->title}}">
          <div class="card-wrapper">
            <div class="card-img">
              <img src="{{asset('/storage/app/public/')}}/{{$especie->imatge}}" layout="responsive" width="316.5" height="211" alt="Mobirise">
            </div>
            <div class="card-box">
              ...
              <p class="mbr-text mbr-fonts-style align-center display-7">{{$especie->description}}</p>
            </div>
          </div>
        </a>
      </div>
