...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    ...
    <div class="navbar-collapse collapse justify-content-between align-items-center w-100" id="collapsingNavbar2" role="navigation">
        <ul class="navbar-nav mx-auto text-md-center text-left">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#info">@isset($especie->title){{$especie->title}}@endisset</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#apadrina">@isset($administra){{$administra->menu3}}@endisset</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#seccions">@isset($administra){{$administra->menu7}}@endisset</a>
            </li>
            <li class="nav-item">
